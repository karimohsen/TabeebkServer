...
import com.tabeebkServer.dao.ReservationDao;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session.getAttribute("Accountid") != null) {
            try {
                ...
                ArrayList<Schedule> sch = ScheduleDao.getSchedule(ac.getDoctor().getDoctorId());
                ArrayList<Reservation> res = ReservationDao.getReservations(sch);
                request.setAttribute("reservations", res);
                RequestDispatcher rd = request.getRequestDispatcher("Doctor/DoctorReservations.jsp");
