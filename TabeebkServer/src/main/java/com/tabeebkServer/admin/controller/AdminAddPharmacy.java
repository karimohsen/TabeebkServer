 ...
 * @author Karim
 */
public class AdminAddPharmacy extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isMultipart) {
            ...
            try {
                ...
                while (iter.hasNext()) {
                    ...
                    if (item.isFormField()) {
                        if (item.getFieldName().equals("name")) {
                            p.setPharamacyName(item.getString());
                        } else if (item.getFieldName().equals("namear")) {
                            p.setPharamacyNameAr(item.getString("UTF-8").trim());
                        }
                    } else {
                ...
                this.getServletConfig().getServletContext().setAttribute("newpharmacy", p);
