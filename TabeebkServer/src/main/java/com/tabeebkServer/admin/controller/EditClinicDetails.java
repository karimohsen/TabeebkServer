...
public class EditClinicDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("Admin/EditClinic.jsp");
        ...
        if (session.getAttribute("Accountid") != null) {
            ...
            ArrayList<Telephone> teleList = TelephoneDao.getTelephones(2,clinicId);
            ...
            Clinic c = ClinicDao.getClinicData(clinicId);
            request.setAttribute("clinic", c);
            Branche b = BranchDao.getBranch(2, clinicId);
