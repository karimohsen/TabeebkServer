        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-ambulance"></i> Edit Lab
                                </li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    <div class="row">
                        <form id="contactform" method="POST" action="${pageContext.request.contextPath}/UpdateLabDetails">
                            <input id="labid" name="labid" value="<c:out value='${lab.getLabId()}'/>" type="hidden">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <input id="name" name="name" required="true" tabindex="1" type="text" value="<c:out value='${lab.getLabName()}'/>"/>                      
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="namear" name="namear"  required="true" tabindex="2" type="text" value="<c:out value='${lab.getLabNameAr()}'/>">                      
                                    </td>
                                </tr>
                                <tr>
                                    <td><p class="contact"><label for="name">Lab Branch Name</label></p></td>

                                    <td>
                                        <input id="labBranch" name="labBranch"  required="true" tabindex="3" type="text" value="<c:out value='${branch.getBrancheName()}'/>">                      
                                    </td>
                                </tr>
                                <tr>
                                    <td><p class="contact"><label for="name">Lab Branch Name Arabic</label></p></td>

                                    <td>
                                        <input id="labBranchAr" name="labBranchAr"  required="true" tabindex="4" type="text" value="<c:out value='${branch.getBrancheNameAr()}'/>">                      
                                    </td>
                                </tr>
                                <tr>
                                    <td><p class="contact"><label for="name">Lab Address</label></p></td>

                                    <td>
                                        <input id="labadd" name="labadd"  required="true" tabindex="5" type="text" value="<c:out value='${branch.getBrancheAddress()}'/>">                      
                                    </td>
                                </tr>
                                <tr>
                                    <td><p class="contact"><label for="name">Lab Address Arabic</label></p></td>

                                    <td>
                                        <input id="labaddar" name="labaddar"  required="true" tabindex="6" type="text" value="<c:out value='${branch.getBrancheAddressAr()}'/>">                      
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2"><p class="contact"><label for="name">Hospital  :</label></p></td>
                                </tr>
                                <c:forEach var="hospital" items="${requestScope.allHospitals}">
                                    <tr>
                                        <td colspan="2"><input TYPE="radio" name="hospital" VALUE="${hospital.getHospitalId()}" <c:if test="${hospital.getHospitalId() == labHospital.getHospitalId()}">checked="checked"</c:if>> <c:out value="${hospital.getHospitalName()}"/>/<c:out value="${hospital.getHospitalNameAr()}"/></td>
                                        </tr>
                                </c:forEach>
                                <tr>
                                    <td colspan="2"><p class="contact"><label for="name">Specialities</label></p></td>
                                </tr>
                                <c:forEach var="speciality" items="${requestScope.mylabspeciality}">
                                    <tr>
                                        <td colspan="2"><input TYPE="checkbox" name="specialities" VALUE="${speciality.getLabspeciality().getId()}" <c:if test="${speciality.isChecked() eq true}"> checked="checked"</c:if>   ><c:out value="${speciality.getLabspeciality().getSpecialityName()}"/>/<c:out value="${speciality.getLabspeciality().getSpecialityNamear()}"/></td>
                                        </tr>
                                </c:forEach>
                                <tr>
