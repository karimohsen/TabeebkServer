        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="row">
                        <form id="contactform" method="POST" action="${pageContext.request.contextPath}/AddPlan"> 
                            <table>
                                <tr>
                                    <td><p class="contact"><label for="name">Plan Name</label></p></td>

                                    <td>
                                        <input id="name" name="planname" required="true" tabindex="1" type="text"/>                      
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="plannamear" name="plannamear"  required="true" tabindex="2" type="text">                      
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="plandesc" name="plandesc" required="true" tabindex="3" type="text">                      
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <input id="plandescar" name="plandescar" required="true" tabindex="4" type="text">                      
                                    </td>
                                </tr>
