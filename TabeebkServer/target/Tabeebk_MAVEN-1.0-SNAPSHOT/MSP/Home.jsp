        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="${pageContext.request.contextPath}/MSP/Home.jsp">Tabeebak</a>
                </div>
                <!-- Top Menu Items -->
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <img src="${pageContext.request.contextPath}/images/mic.jpg" height="500" width="1100"/>
                        </div>
                    </div>
                    <!-- /.row -->
