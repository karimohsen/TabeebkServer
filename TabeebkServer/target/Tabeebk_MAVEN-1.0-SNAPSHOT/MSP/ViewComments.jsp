                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">
                                    <i class="fa fa-group"></i> <a href="Home.jsp">View Users</a>
                                </li>
                                <li class="active">
                                    <i class="fa fa-group"></i> View Comments
                                </li>
                            </ol>
                            <div class="row">
                                ...
                                <tbody>
                                    <c:forEach var="userRat" items="${requestScope.userRats}">
                                        <tr id="${userRat.getRatingId()}">
                                            <td>
                                                <c:out value="${userRat.getRatingComment()}"/>
                                            </td>
                                            <td>
                                                <c:out value="${userRat.getRatingValue()}"/>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
